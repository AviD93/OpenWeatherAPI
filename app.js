...
btn.addEventListener('click', function() {
    ...
    if (cityName != "") {
        ...
        const API = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=2cf26a0cbe13cbe0caeb15ff772be510`;
        ...
        xhr.onload = function() {
            ...
            temp = temp - 273.15;
            temp = Math.round(temp); //מעגל את התוצאה או כלפיי מעלה או מטה 23.7 =24 
            temp = temp + "*C";
            console.log(temp);
